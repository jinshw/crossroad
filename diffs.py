...
class Ui_diffs(object):
    def setupUi(self, diffs):
        ...
        self.leftOpenBT.setGeometry(QtCore.QRect(480, 50, 75, 23))
        self.leftOpenBT.setObjectName("leftOpenBT")
        self.leftPathLE = QtWidgets.QLineEdit(diffs)
        self.leftPathLE.setGeometry(QtCore.QRect(90, 50, 381, 20))
        ...
        self.leftRoadidLE.setGeometry(QtCore.QRect(490, 120, 181, 20))
        self.leftRoadidLE.setObjectName("leftRoadidLE")
        self.leftFilterBT = QtWidgets.QPushButton(diffs)
        self.leftFilterBT.setGeometry(QtCore.QRect(680, 120, 75, 23))
        ...
        self.leftXMLOpenBT = QtWidgets.QPushButton(diffs)
        self.leftXMLOpenBT.setGeometry(QtCore.QRect(480, 80, 75, 23))
        self.leftXMLOpenBT.setObjectName("leftXMLOpenBT")
        self.leftXMLPathLE = QtWidgets.QLineEdit(diffs)
        self.leftXMLPathLE.setGeometry(QtCore.QRect(90, 80, 381, 20))
        self.leftXMLPathLE.setObjectName("leftXMLPathLE")
        self.label_3 = QtWidgets.QLabel(diffs)
        self.label_3.setGeometry(QtCore.QRect(30, 80, 51, 16))
        self.label_3.setObjectName("label_3")
        self.leftXMLFilterBT = QtWidgets.QPushButton(diffs)
        self.leftXMLFilterBT.setGeometry(QtCore.QRect(770, 120, 75, 23))
        self.leftXMLFilterBT.setObjectName("leftXMLFilterBT")
        self.runXMLBT = QtWidgets.QPushButton(diffs)
        self.runXMLBT.setGeometry(QtCore.QRect(310, 120, 75, 23))
        self.runXMLBT.setObjectName("runXMLBT")
        self.objectNameComboBox = QtWidgets.QComboBox(diffs)
        self.objectNameComboBox.setGeometry(QtCore.QRect(690, 20, 221, 22))
        self.objectNameComboBox.setObjectName("objectNameComboBox")
        self.label_4 = QtWidgets.QLabel(diffs)
        self.label_4.setGeometry(QtCore.QRect(630, 22, 41, 20))
    ...
    def retranslateUi(self, diffs):
        ...
        self.leftXMLOpenBT.setText(_translate("diffs", "打开"))
        self.label_3.setText(_translate("diffs", "xml文件："))
        self.leftXMLFilterBT.setText(_translate("diffs", "XML筛选"))
        self.runXMLBT.setText(_translate("diffs", "执行XML"))
        self.label_4.setText(_translate("diffs", "类型："))
